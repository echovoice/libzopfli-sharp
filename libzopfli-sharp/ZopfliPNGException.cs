...
{
    public class ZopfliPNGException : Exception, ISerializable
    {
        public ZopfliPNGException() : base("unknown error") { }

        public ZopfliPNGException(int error) : base(errorMessage(error)) { }

        public ZopfliPNGException(int error, Exception inner) : base(errorMessage(error), inner) { }

        public ZopfliPNGException(string message) : base(message) { }

        public ZopfliPNGException(string message, Exception inner) : base(message, inner) { }

        protected ZopfliPNGException(SerializationInfo info, StreamingContext context) : base(info, context) { }
